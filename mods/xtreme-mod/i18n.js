...
i18n = {
    'th': {
        ...
        'confirmEndTurnText': "{0} ต้องการจบตาหรือไม่?<br>สาเหตุ:<br>{1}", 'endTurnButton': "จบตา", 'okButton': "ตกลง",
        ...
        'log_choseToWaitInJail': "{0} เลือกที่จะรอทอยตาหน้า", 'log_drawCard': "{0} หยิบการ์ด {1} (ยังไม่พัฒนา)",
    ...
    'en': {
        ...
        'confirmEndTurnText': "{0}, end your turn?<br>reason:<br>{1}", 'endTurnButton': "End Turn", 'okButton': "OK",
        ...
        'log_choseToWaitInJail': "{0} chose to wait next turn", 'log_drawCard': "{0} drew {1} (Not developed)",
    ...
    'jp': { // Mostly placeholders, needs full translation
        ...
        'confirmEndTurnText': "{0}さん、終了しますか？<br>原因:<br>{1}", 'endTurnButton': "終了", 'okButton': "OK",
    ...
    'cn': { // Mostly placeholders, needs full translation
        ...
        'confirmEndTurnText': "{0}, 结束回合吗？<br>原因:<br>{1}", 'endTurnButton': "结束", 'okButton': "确定",
